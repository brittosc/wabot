...
async function resetStatistics() {
    ...
    try {
        ...
        console.log('✅ Sucesso: Todas as estatísticas foram removidas da tabela "votes".');
...
console.log('Script de reset carregado. Para executar, edite o arquivo e descomente a chamada da função resetStatistics().');
